...
const Pinconfig_t GPIOPins[]={
		...
		/* Setting GPIO functionality for selected 4 data pins for LCD */
		{ LPC_GPIO1, P1_23, FUNC0 },      //P1_23
		{ LPC_GPIO1, P1_24, FUNC0 },      //P1_24
		{ LPC_GPIO1, P1_25, FUNC0 },      //P1_25
		{ LPC_GPIO1, P1_26, FUNC0 },      //P1_26

		/* Setting GPIO functionality for selected 4 control pins for LCD */
		{ LPC_GPIO0, P0_4, FUNC0 },       //P0_4
		{ LPC_GPIO0, P0_5, FUNC0 },		  //P0_5
		{ LPC_GPIO0, P0_6, FUNC0 },		  //P0_6

		/* Setting GPIO functionality for PS2 Data line */
		{ LPC_GPIO0, P0_10, FUNC0 }      //P0_10

};

const Pinconfig_t ExtIntPins[]={

		/* Setting External interrupt functionality for PS2 Clock line */
		{ LPC_GPIO2, nENT0, FUNC1 },      //P2_10/BLD
		{  LPC_GPIO2,  nENT1,  FUNC1  }      //P2_11
...
void vPinmuxInitialize(void)
{
	...
	/* Setting GPIO functionality for selected 4 control pins for LCD */
	vPinmuxSel(GPIOPins[4].GPIOx, GPIOPins[4].pin, GPIOPins[4].func);
	vPinmuxSel(GPIOPins[5].GPIOx, GPIOPins[5].pin, GPIOPins[5].func);
	vPinmuxSel(GPIOPins[6].GPIOx, GPIOPins[6].pin, GPIOPins[6].func);

	/* Setting GPIO functionality for PS2 Data line */
	vPinmuxSel(GPIOPins[7].GPIOx, GPIOPins[7].pin, GPIOPins[7].func);

	/* Setting External interrupt functionality for PS2 Clock line */
	vPinmuxSel(ExtIntPins[0].GPIOx, ExtIntPins[0].pin, ExtIntPins[0].func);
	vPinmuxSel(ExtIntPins[1].GPIOx, ExtIntPins[1].pin, ExtIntPins[1].func);
}
